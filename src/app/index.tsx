...
export default function HomeScreen() {
  ...
  return <View style={{ flex: 1, backgroundColor: '#f4f7f6' }} {...pan.panHandlers}>
    <SectionList
      ...
      ListEmptyComponent={<View style={{ alignItems: 'center', padding: 48, gap: 9 }}><Text style={{ fontSize: 30 }}>⌕</Text><Text selectable style={{ color: '#24443a', fontSize: 18, fontWeight: '700' }}>No medicines found</Text><Text selectable style={{ color: '#71827a', textAlign: 'center' }}>Try a shorter name or another category.</Text></View>}
    />
